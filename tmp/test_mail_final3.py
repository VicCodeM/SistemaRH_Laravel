...
try {
    Mail::raw('Este es un correo de prueba después de haber subido tu código PHP más reciente. El sistema sigue funcionando y enviando correos correctamente desde el dominio verificado vmsoi.xyz.', function($message) {
        $message->to('luisyoumi@gmail.com')
                ->subject('Prueba con código nuevo - SistemaRH');
    });
