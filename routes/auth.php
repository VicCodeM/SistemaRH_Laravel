...
Route::middleware('guest')->group(function () {
    Route::get('register/candidato', [RegisteredUserController::class, 'create'])
        ->name('register.candidato');
    Route::post('register/candidato', [RegisteredUserController::class, 'store']);

    Route::get('register/empresa', [RegisterEmpresaController::class, 'create'])
        ->name('register.empresa');
    Route::post('register/empresa', [RegisterEmpresaController::class, 'store']);
