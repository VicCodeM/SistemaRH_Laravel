<div style="padding:28px;">
    <div style="display:flex; align-items:center; gap:14px; margin-bottom:20px;">
        ...
        <div>
            <h2 style="margin:0;font-size:1.1rem;font-weight:700;">Rechazar acceso de empresa</h2>
            <p style="margin:4px 0 0;color:#64748b;font-size:0.88rem;">Esta acción cambia el estado a <strong>Rechazada</strong> e impide el acceso a la plataforma.</p>
        </div>
    </div>

    <div style="padding:14px 16px;border-radius:10px;background:#f8fafc;border:1px solid var(--border);margin-bottom:20px;">
        <p style="margin:0;font-size:0.95rem;font-weight:600;color:var(--text);">{{ $empresa->nombre_empresa }}</p>
        <p style="margin:4px 0 0;font-size:0.83rem;color:#64748b;">{{ $empresa->usuario?->email }} &middot; RFC: {{ $empresa->rfc ?: 'No capturado' }}</p>
    </div>

    <p style="margin:0 0 20px;color:#475569;font-size:0.9rem;">¿Confirmas que deseas rechazar el acceso de esta empresa? Podrás reactivarla más adelante si es necesario.</p>
