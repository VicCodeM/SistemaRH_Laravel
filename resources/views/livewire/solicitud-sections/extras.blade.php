        ...
        <div style="margin-bottom:22px;">
            ...
            <div class="solicitud-grid-2">
                <div class="form-group" style="margin:0;">
                    ...
                    <input type="text" class="form-input" wire:model.blur="curp" placeholder="CURP (18 caracteres)" spellcheck="true" autocapitalize="sentences">
                </div>
                <div class="form-group" style="margin:0;">
                    <label class="form-label">NSS — Número de seguro social <span class="req">*</span></label>
                    <input type="text" class="form-input" wire:model.blur="nore_seguro_social" placeholder="Número de seguro social" spellcheck="true" autocapitalize="sentences">
                </div>
                <div class="form-group" style="margin:0;">
                    <label class="form-label">RFC <span class="req">*</span></label>
                    <input type="text" class="form-input" wire:model.blur="rfc" placeholder="RFC" spellcheck="true" autocapitalize="sentences">
                </div>
                <div class="form-group" style="margin:0;">
                    <label class="form-label">Afore <span class="req">*</span></label>
                    <input type="text" class="form-input" wire:model.blur="afore" placeholder="Nombre de tu Afore" spellcheck="true" autocapitalize="sentences">
                </div>
            </div>
        </div>
            ...
            <div style="background:var(--surface-2);border:1px solid var(--border);border-radius:12px;padding:16px;">
                ...
                @if($cartilla_tiene === 'si')
                    <div class="form-group" style="margin:0;">
                        ...
                        <input type="text" class="form-input" wire:model.blur="cartilla_militar" placeholder="Número de cartilla militar" spellcheck="true" autocapitalize="sentences">
                    </div>
                @endif
            </div>
        </div>
            ...
            <div style="background:var(--surface-2);border:1px solid var(--border);border-radius:12px;padding:16px;">
                ...
                @if($pasaporte_tiene === 'si')
                    <div class="form-group" style="margin:0;">
                        ...
                        <input type="text" class="form-input" wire:model.blur="pasaporte" placeholder="Número de pasaporte" spellcheck="true" autocapitalize="sentences">
                    </div>
                @endif
            </div>
        </div>
                ...
                @if($licenciaTiene === 'si')
                    <div class="solicitud-grid-3">
                        <div class="form-group" style="margin:0;">
                            ...
                            <input type="text" class="form-input" wire:model.blur="licencia_conducir.clase" placeholder="Ej. A, B, C" spellcheck="true" autocapitalize="sentences">
                        </div>
                        <div class="form-group" style="margin:0;">
                            <label class="form-label">Número</label>
                            <input type="text" class="form-input" wire:model.blur="licencia_conducir.numero" placeholder="Número de licencia" spellcheck="true" autocapitalize="sentences">
                        </div>
                        <div class="form-group" style="margin:0;">
                        ...
                        <div wire:key="referencia-{{ $index }}" style="border:1px solid var(--border);border-radius:12px;padding:16px;background:var(--surface-2);">
                            <div class="solicitud-grid-4" style="margin-bottom:10px;">
                                <div class="form-group" style="margin:0;">
                                    ...
                                    <input type="text" class="form-input" wire:model.blur="referencias_personales.{{ $index }}.nombre" placeholder="Nombre completo" spellcheck="true" autocapitalize="sentences">
                                </div>
                                <div class="form-group" style="margin:0;">
                                    <label class="form-label">Teléfono</label>
                                    <input type="text" class="form-input" wire:model.blur="referencias_personales.{{ $index }}.telefono" placeholder="Teléfono" spellcheck="true" autocapitalize="sentences">
                                </div>
                                <div class="form-group" style="margin:0;">
                                    <label class="form-label">Ocupación</label>
                                    <input type="text" class="form-input" wire:model.blur="referencias_personales.{{ $index }}.ocupacion" placeholder="Ocupación" spellcheck="true" autocapitalize="sentences">
                                </div>
                                <div class="form-group" style="margin:0;">
                                    <label class="form-label">Tiempo de conocerlo</label>
                                    <input type="text" class="form-input" wire:model.blur="referencias_personales.{{ $index }}.tiempo" placeholder="Ej. 3 años" spellcheck="true" autocapitalize="sentences">
                                </div>
                            </div>
                            <div style="display:flex;gap:10px;align-items:flex-end;">
                                <div class="form-group" style="margin:0;flex:1;">
                                    <label class="form-label">Domicilio</label>
                                    <input type="text" class="form-input" wire:model.blur="referencias_personales.{{ $index }}.domicilio" placeholder="Domicilio de la referencia" spellcheck="true" autocapitalize="sentences">
                                </div>
