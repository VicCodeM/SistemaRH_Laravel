<div style="background:#fff;border:1px solid var(--border);border-radius:16px;overflow:hidden;box-shadow:var(--shadow-sm);margin-top:6px;">
    <div style="padding:18px 24px 14px;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:12px;background:linear-gradient(135deg,#fff7ed,#f8fafc);">
        <div style="width:36px;height:36px;border-radius:10px;background:rgba(245,158,11,.12);color:#f59e0b;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
        ...
        <div>
            <h3 style="margin:0;font-size:.95rem;font-weight:700;color:var(--text);">Experiencia laboral</h3>
            <p style="margin:2px 0 0;font-size:.78rem;color:var(--text-muted);">Historial de empleos y aspiración salarial</p>
        </div>
    </div>
    ...
    <div style="padding:22px 24px;">
        ...
        <div style="margin-bottom:20px;">
            <p style="font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.8px;color:#f59e0b;margin:0 0 10px;">Aspiración salarial</p>
            <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;">
                <div class="form-group" style="margin:0;">
                    <label class="form-label">Sueldo deseado</label>
