        ...
        <div style="margin-bottom:22px;">
            ...
            <div class="solicitud-grid-2">
                <div class="form-group" style="margin:0;">
                    ...
                    <input type="text" class="form-input" wire:model.blur="telefono" placeholder="Número de teléfono (opcional)" spellcheck="true" autocapitalize="sentences">
                </div>
                <div class="form-group" style="margin:0;">
                    <label class="form-label">Celular <span style="color:var(--danger);">*</span></label>
                    <input type="text" class="form-input" wire:model.blur="celular" placeholder="Número de celular" spellcheck="true" autocapitalize="sentences">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div style="display:grid;gap:12px;">
                <div class="form-group" style="margin:0;">
                    ...
                    <input type="text" class="form-input" wire:model.blur="domicilio" placeholder="Calle, número y referencias" spellcheck="true" autocapitalize="sentences">
                </div>
                <div class="solicitud-grid-2">
                    <div class="form-group" style="margin:0;">
                        <label class="form-label">Colonia <span style="color:var(--danger);">*</span></label>
                        <input type="text" class="form-input" wire:model.blur="colonia" placeholder="Colonia" spellcheck="true" autocapitalize="sentences">
                    </div>
                    <div class="form-group" style="margin:0;">
                        <label class="form-label">Código postal <span style="color:var(--danger);">*</span></label>
                        <input type="text" class="form-input" wire:model.blur="codigo_postal" placeholder="CP" spellcheck="true" autocapitalize="sentences">
                    </div>
                </div>
                <div class="solicitud-grid-2">
                    <div class="form-group" style="margin:0;">
                        <label class="form-label">Municipio <span style="color:var(--danger);">*</span></label>
                        <input type="text" class="form-input" wire:model.blur="municipio" placeholder="Municipio" spellcheck="true" autocapitalize="sentences">
                    </div>
                    <div class="form-group" style="margin:0;">
                        <label class="form-label">Ciudad <span style="color:var(--danger);">*</span></label>
                        <input type="text" class="form-input" wire:model.blur="ciudad" placeholder="Ciudad" spellcheck="true" autocapitalize="sentences">
                    </div>
                </div>
            </div>
        </div>
