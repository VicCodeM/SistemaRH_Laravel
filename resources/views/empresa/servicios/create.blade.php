<x-app-layout>
    <x-slot name="header">
        <nav class="breadcrumbs">
            ...
            <a href="{{ route('empresa.servicios.index') }}">Servicios disponibles</a>
            <span class="breadcrumb-sep">&rsaquo;</span>
    ...
    @if($servicioSeleccionado)
        <div style="max-width:920px; display:flex; flex-direction:column; gap:18px;">
                ...
                <div style="display:flex; justify-content:space-between; gap:16px; flex-wrap:wrap; align-items:flex-start;">
                    <div style="min-width:260px;">
                        <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap; margin-bottom:10px;">
                            ...
                            @elseif($servicioSeleccionado->usaNivelJerarquicoPara('empresa') && $servicioSeleccionado->nivel_jerarquico !== 'todos')
                                <span class="badge badge-blue">
                ...
                <div class="card" style="padding:24px;">
                    <div style="display:flex; justify-content:space-between; gap:16px; flex-wrap:wrap; align-items:flex-start;">
                        ...
                        <div style="display:flex; gap:10px; flex-wrap:wrap; justify-content:flex-end;">
                            <a href="{{ route('empresa.servicios.index') }}" class="btn btn-secondary">Volver a la lista</a>
            ...
            @else
                <form method="POST" action="{{ route('empresa.servicios.guardar') }}" style="display:flex; flex-direction:column; gap:18px;">
                    @csrf
                    ...
                    <div class="card" style="padding:24px;">
                        <h2 style="margin:0 0 14px; font-size:14px; font-weight:700; text-transform:uppercase; letter-spacing:.04em; color:#475569;">2. Detalles de la solicitud</h2>

                        <div style="margin-bottom:14px;">
                            <label class="form-label">Cuantas horas durara aproximadamente?</label>
                        ...
                        <label class="form-label">Que necesitas exactamente? *</label>
                        <textarea name="notas" rows="6" class="form-input" required maxlength="2000"
                                  placeholder="Describe el objetivo, fechas tentativas, numero de personas involucradas, ubicacion, etc."
                                  spellcheck="true" autocorrect="on" autocapitalize="sentences" lang="es">{{ old('notas') }}</textarea>
                        <p style="margin:6px 0 0; font-size:11px; color:#94a3b8;">Mientras mas detallado, mas rapido podremos asignar al responsable adecuado.</p>
                    </div>
