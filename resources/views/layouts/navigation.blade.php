<nav class="sidebar">
    <div class="sidebar-brand">
        <a href="{{ route('dashboard') }}" style="text-decoration: none;">
            <h2 style="color: #fff; margin: 0;">Sistema<span style="color: #3b82f6;">RH</span></h2>
            <span>Panel {{ ucfirst(Auth::user()?->rol ?? '') }}</span>
        </a>
    </div>
    ...
    <div class="sidebar-nav">
        ...
        @if(Auth::user()?->rol === 'admin')
            ...
            <a wire:navigate href="{{ route('admin.dashboard') }}" class="sidebar-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6z"/></svg>
                Panel Admin
            </a>
            ...
            <a wire:navigate href="{{ route('admin.catalogo.index') }}" class="sidebar-link {{ request()->routeIs('admin.catalogo*') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z"/></svg>
                Catálogo de Servicios
            </a>

            <a wire:navigate href="{{ route('admin.personal-externo.index') }}" class="sidebar-link {{ request()->routeIs('admin.personal-externo*') ? 'active' : '' }}">
        ...
        @if(Auth::user()?->rol === 'candidato')
            ...
            <a wire:navigate href="{{ route('candidato.vacantes') }}" class="sidebar-link {{ request()->routeIs('candidato.vacantes*') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 00-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22A2.016 2.016 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0"/></svg>
        ...
        @if(Auth::user()?->rol === 'interno')
            <div class="sidebar-label">Operaciones</div>

            <a wire:navigate href="#" class="sidebar-link">
        ...
        @if(in_array(Auth::user()?->rol, ['admin', 'empresa']))
            ...
            <a wire:navigate href="{{ route('tickets.index') }}" class="sidebar-link {{ request()->routeIs('tickets.*') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"/></svg>
                Tickets
            </a>
        @endif
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <p class="sidebar-user-role">{{ Auth::user()?->rol ?? 'invitado' }}</p>
            </div>
        </div>
